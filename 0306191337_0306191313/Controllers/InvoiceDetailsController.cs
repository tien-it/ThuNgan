...
namespace _0306191337_0306191313.Controllers
{
    public class InvoiceDetailsController : Controller
    {
        ...
        public InvoiceDetailsController(_0306191337_0306191313Context context)
        {
            _context = context;
        }
        ...
        {
            var _0306191337_0306191313Context = _context.InvoiceDetails.Include(i => i.Invoice).Include(i => i.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,InvoiceId,ProductId,Quantity,UnitPrice")] InvoiceDetail invoiceDetail)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Set<Product>(), "Id", "Name", invoiceDetail.ProductId);
            return View(invoiceDetail);
        }
